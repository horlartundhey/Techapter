            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Elioenai Yomi</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="blog-content col-md-8 col-md-offset-1">
                        <div class="single-item item">
                            ...
                            <div class="info">
                                ...
                                <p>
                                Elioenai Yomi is a Graduate of the University of Portharcourt, with an MBA from Nexford University he's also a renowned Project Manager, Web Developer, Product Designer, Cybersecurity Professional an astute Business developer, and expert Tech Consultant with Certificates in CEH, CCNA, A+, IOT, S+, IOE & N+.  

                                He’s currently the Cofounder and CEO of Sumiffy Group Limited, CTO of Signator Technologies and Creative Director of Trawlr x and The Creatives Island.
                                </p>

                                
                                <p>
                                When he's not working, writing, podcasting or traveling, he reviews books with kids and encourages young people to read through his Non-Profit Organization, The Everyday Chapter (TEC), with laudable literary and art projects spread across Nigeria.
