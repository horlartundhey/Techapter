<div class="sidebar col-md-4">
                        <aside>
                            ...
                            <div class="sidebar-item recent-post">
                                ...
                                <ul>
                                <?php
                $stmt = $db->query('SELECT postTitle, postSlug, postDate, postImage FROM blog_posts_seo ORDER BY rand() asc  limit 3');
                while($row = $stmt->fetch()) {
                    echo ' <li>
                                        <div class="info">
                                            <a href="'.$row['postSlug'].'">'. $row['postTitle'] .'</a>
                                            <div class="meta-title">
                                                <span class="post-date">'.date('M jS  Y ', strtotime($row['postDate'])).'</span></a>
                                            </div>
                                        </div>
                                    </li>
                                    ';
