            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="team-items team-carousel owl-carousel owl-theme text-center">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="assets/img/Amara.png" alt="Thumb">                                
                            </div>
                            <div class="info">                                                                
                                <h4>Amarachukwu Chimeka</h4>
                                <h5 style="font-weight: bold; color:#f2801c;">Board Chairman</h5>
                                <div class="about">
                                    <p>
                                    She is a seasoned Copyeditor, Profreader, Copywriter, and Publisher with certifications from the Chartered Institute of  Editing and Proofreading CIEP....
                                    </p>
                                    <br>
                                    <a class="btn circle btn-theme border btn-sm" href="amara.php">Read More...</a>                                    
                                </div>
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="assets/img/Obi.jpeg" alt="Thumb">
                                
                            </div>
                            <div class="info">                             
                                <h4>Ever Obi</h4>
                                <h5 style="font-weight: bold; color:#f2801c;">Board Member</h5>
                                <div class="about">
                                    <p>
                                    Ever Obi is a business executive and fiction writer based in Lagos. His debut, the acclaimed mystical novel Men Don’t Die was published in 2019 and explores themes of death and spiritualism.....
                                    </p>
                                    <br>
                                    <a class="btn circle btn-theme border btn-sm" href="obi.php">Read More...</a>                                    
                                </div>
                            </div>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="assets/img/yomi.jpeg" alt="Thumb">
                            ...
                            <div class="info">                             
                                ...
                                <div class="about">
                                    <p>
                                    Elioenai Yomi is a Graduate of the University of Portharcourt, with an MBA from Nexford University he's also a renowned Project Manager, Web Developer....
                                    </p>
                                    <br>
                                    <a class="btn circle btn-theme border btn-sm" href="yomi.php">Read More...</a>                                    
                                </div>
                            </div>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="assets/img/Tolu.jpeg" alt="Thumb">
                                
                            </div>
                            <div class="info">                             
                                <h4>Tolu’ A. Akinyemi</h4>
                                <h5 style="font-weight: bold; color:#f2801c;">Board Member</h5>
                                <div class="about">
                                    <p>
                                    Tolu’ A. Akinyemi (also known as Tolutoludo & Lion of Newcastle) is a multi-award-winning author in the genre of poetry, short stories, children’s literature, and essays....
                                    </p>
                                    <br>
                                    <a class="btn circle btn-theme border btn-sm" href="tolu.php">Read More...</a>                                    
                                </div>
                            </div>
                        </div>
                        <!-- End Single Item -->
